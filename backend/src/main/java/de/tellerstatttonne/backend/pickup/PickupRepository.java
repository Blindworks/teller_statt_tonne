...
public interface PickupRepository extends JpaRepository<PickupEntity, Long> {
    ...
    boolean existsByPartnerIdAndDateAndStartTime(
        Long partnerId, LocalDate date, String startTime);

    List<PickupEntity> findByPartnerIdAndAutoGeneratedTrueAndStatusAndDateGreaterThanEqual(
        Long partnerId, Pickup.Status status, LocalDate from);
